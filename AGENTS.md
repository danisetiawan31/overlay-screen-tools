...
This project is indexed by GitNexus as **overlay-screen-tools** (566 symbols, 1143 relationships, 47 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
