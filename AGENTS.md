...
This project is indexed by GitNexus as **overlay-screen-tools** (98 symbols, 100 relationships, 2 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
