...
This project is indexed by GitNexus as **overlay-screen-tools** (550 symbols, 1099 relationships, 46 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
