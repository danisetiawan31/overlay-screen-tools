...
- [x] Tray icon & app lifecycle (Tahap 1/2: tray, menu, quit flow) — selesai, spec: docs/TDD.md §9 & docs/PRD.md §3.3
  Catatan: sesuai spec. Inisialisasi TrayIconBuilder dengan context menu 2 item ("Show/Hide Overlay" & "Quit"); logic toggle Normal/Concealed diekstrak ke fungsi standalone toggle_overlay_visibility dengan method OverlayState::toggle_concealed; menu Quit memicu close lifecycle & flush-on-exit windowBounds; 15 unit test lolos.
