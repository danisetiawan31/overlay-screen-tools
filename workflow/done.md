...
- [x] Notes/Teleprompter mode (Tahap 1 & 2: core watcher, events, auto-restore, get_notes_state command, File Mode & Scratchpad) — selesai, spec: docs/TDD.md §6 & docs/PRD.md §3.1 & docs/api-contract.md §1 & §2
